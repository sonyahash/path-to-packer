...
export HCP_PACKER_BUCKET_SLUG2="path-to-packer-azure"
export HCP_PACKER_CHANNEL_SLUG2="path-to-packer-production"
...
export HCP_PACKER_API_CREATE_CHANNEL2=${HCP_PACKER_BASE_URL}/images/${HCP_PACKER_BUCKET_SLUG2}/channels
export HCP_PACKER_API_PATCH_CHANNEL2=${HCP_PACKER_BASE_URL}/images/${HCP_PACKER_BUCKET_SLUG2}/channels/${HCP_PACKER_CHANNEL_SLUG2}
export HCP_PACKER_API_GET_BUCKET2=${HCP_PACKER_BASE_URL}/images/${HCP_PACKER_BUCKET_SLUG2}
export HCP_PACKER_DELETE_BUCKET2=${HCP_PACKER_BASE_URL}/images/${HCP_PACKER_BUCKET_SLUG2}
